	...
	<body>
		...
		<nav></nav>
			<main>
				...
				if (isset($_REQUEST['gama'])) { // "isset" determina si una variable está definida y no es "null".
					$gama = $_REQUEST['gama'];
					// Enviar consulta:
					...
					echo "<br><p><a href='DWES ejercicio 3.1.2 (solución).php'>Realizar nueva consulta</a></p>";
				} else {
					...
					echo "<form action='DWES ejercicio 3.1.2 (solución).php' method='GET'>";
