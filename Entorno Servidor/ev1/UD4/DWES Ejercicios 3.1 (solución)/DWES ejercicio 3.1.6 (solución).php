	...
	<body>
		...
		<nav></nav>
			<main>
				<?php
				if (!$_REQUEST) {
					echo "<form  action='DWES ejercicio 3.1.6 (solución).php' method='get'>";
					...
					if (!isset($_REQUEST["modificar"])) { // "isset" determina si una variable está definida y no es "null".
				...
				?>
				<table>
					<form action='DWES ejercicio 3.1.6 (solución).php' method='GET'>
						<tr>
							<td>CodigoCliente:</td>
						...
						<tr>
							...
							<td><a href='DWES ejercicio 3.1.6 (solución).php'>Vuelve al listado de clientes</a></td>
						</tr>
					</form>
				</table>
				<?php
						...
						echo "<a href = 'DWES ejercicio 3.1.6 (solución).php'>Vuelta al formulario de inserción</a><br/>";
					}
				}
				?>
			</main>		
