		...
		<nav></nav>
			<main>
				...
				?>
					...
					<form action='DWES ejercicio 3.1.11 (solución).php' method='get'>
				...
				<?php
					...
					mysqli_select_db ($conexion, "jardineria")
						or die ("No se puede seleccionarc la BD");
					...
					$resulcomprobacion = mysqli_query ($conexion, $sqlcomprobarusuario)
						or die ("Fallo en acceso a comprobación");
					...
					if (password_verify ($pass, $clave_encriptada)) { // Comprobación satisfactoria: usuario y contraseña correctos.
						...
						print ("<p>[ <a href='DWES ejercicio 3.1.11 (solución).php'>Volver a intentar identificarse</a> ]</p>");
					}
