		...
		<nav></nav>
			<main>
				...
				if (isset($_REQUEST['enviar'])) { // "isset" determina si una variable está definida y no es "null".
					...
					echo "</table>";
					echo "<br/><a href='DWES ejercicio 3.1.4 (solución).php'>Realizar nueva consulta</a>";
				} else {
					...
					print ("<form action='DWES ejercicio 3.1.4 (solución).php' method='GET'>");
