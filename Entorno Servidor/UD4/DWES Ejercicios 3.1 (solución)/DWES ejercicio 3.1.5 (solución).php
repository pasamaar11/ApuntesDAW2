		...
		<nav></nav>
			<main>
				...
				if (isset($_REQUEST['enviar'])) { // "isset" determina si una variable está definida y no es "null".
					// Coger valores del formulario (aunque es más rápido con la función "extract"):
					/*
					...
					*/
					// Equivalente con la función "extract" (se puede ver documentación en "php.net" o en "w3Schools"):
					extract ($_REQUEST);
					
					// Se averigua cuál es el código máximo existente de cliente:
					...
					echo "<a href = 'DWES ejercicio 3.1.5 (solución).php'>Vuelta al formulario de inserción</a><br/>";
				} else {
				?>
					...
					<table>
						...
						<tr>
							...
							<?php
								...
								} // Este input tipo "select" recogerá en su atributo "value" el "CodigoEmpleado" (representante de ventas) de la opción seleccionada.
								mysqli_close ($c);
								echo "</select>";
							?>
							</td>
