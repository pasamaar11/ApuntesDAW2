    ...
    <nav></nav>
        <main>
			...
			if (isset($_REQUEST['enviar'])) { // Se ha recibido código y nombre del cliente y se procede a obtener y mostrar información de sus pedidos.
				...
				// 2 º Buscamos los pedidos del cliente cuyo código se ha enviado desde el formulario:
			...
			echo "<form  action='DWES ejercicio 3.1.9 (solución).php' method='get'>";
